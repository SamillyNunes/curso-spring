...
@JsonTypeInfo(use=JsonTypeInfo.Id.NAME,include=JsonTypeInfo.As.PROPERTY,property="@type") //essa anotacao da dizendo que a classe pagamento tera um atrb adicional chamado @type
