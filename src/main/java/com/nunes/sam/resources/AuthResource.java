...
public class AuthResource {
	...
	@RequestMapping(value = "/forgot", method = RequestMethod.POST) //esse endpoint eh protegido por autenticacao, entao tem que estar logado para acessa-lo
